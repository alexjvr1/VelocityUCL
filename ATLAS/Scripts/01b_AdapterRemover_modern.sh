...
/SAN/ugi/LepGenomics/VelocityPipeline/wrapper/parallel_adapterremoval_modern_UCL.sh \
-i 01a_Trimmomatic_modern \
-o 01b_AdapterRemoval_modern.unmerged \
-n 1 -t 5 -m 8 -N AdaptRem.mod;
