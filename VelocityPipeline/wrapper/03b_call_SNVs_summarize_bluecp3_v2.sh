...
$BCFTOOLS concat -O b -a -d none -f $TMPDIR/bcflist --threads $NTHREADS 2> $INDIR/$OUTF.log > $INDIR/OUTF.b.bcf
...
$BCFTOOLS index $INDIR/OUTF.b.bcf
...
$BCFTOOLS view $INDIR/$OUTF.b.bcf -Ov > $INDIR/$OUTF.b.vcf
