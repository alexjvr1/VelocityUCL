...
echo ">$OUTDIR/\${FQ1%%fastq*}concat.fastq.gz \\\">> \$LOG
echo >> \$LOG
echo "---------------------------------------------------" >> \$LOG
echo >> \$LOG
...
echo "CMD: " >> \$LOG
echo "cat \\\">> \$LOG
echo "$INDIR1/\$FQ2 $INDIR2/\$FQ2 \\\">> \$LOG
echo ">$OUTDIR/\${FQ2%%fastq*}concat.fastq.gz \\\">> \$LOG
echo >> \$LOG
echo "---------------------------------------------------" >> \$LOG
echo >> \$LOG
...
time cat $INDIR1/\$FQ1 $INDIR2/\$FQ1 > $OUTDIR/\${FQ1%%fastq*}concat.fastq.gz
time cat $INDIR1/\$FQ2 $INDIR2/\$FQ2 > $OUTDIR/\${FQ2%%fastq*}concat.fastq.gz
